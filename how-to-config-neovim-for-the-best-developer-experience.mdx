...
date: 2024-05-09
tags: ["IDE", "config", "CLI"]
description: This article walks you through how to set up Neovim and write your config files entirely in Lua. It also introduces you to Neovim’s extensive plugin environment.
---
